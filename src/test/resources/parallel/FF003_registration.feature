...
Feature: Test new user register functionality
  ...
  @RP_TC_002
  Scenario Outline: User Register validation with missing values in the input fields
    When The user enters "<username>" and "<password>" and "<confirm password>" input fields with missing values
    And User clicks the register button
    Then The validation message "Please fill out this field." appears below the input field.
  ...
  @RP_TC_004
  Scenario Outline: User Register validation with diferent values in the password and confirm password text fields
    When The user enters "<username>" and "<password>" and "<confirm password>" input fields with different values in password and confirm password textfields
    And User clicks the register button
    Then The user should able to see warning message "password_mismatch:The two password fields didn’t match"
